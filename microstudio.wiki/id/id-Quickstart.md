**microStudio** merupakan sebuah alat pemrograman game yang terintegrasi.
didalamnya terdapat seluruh fitur yang kamu butuhkan untuk membuat game pertamamu!

**microStudio** menawarkan berbagai macam fitur seperti:

* editor gambar(sprite) (dalam pixel art)
* editor map (map atau level)
* editor kode untuk melakukan pemrograman dalam bahasa microscript, Sebuah bahasa yang simpel yang mumpuni
* Operasi dilakukan 100% secara offline sehingga memudahkan anda melakukan testing pada game pada tahap apapun dalam pembuatan game
* Memudahkan anda dalam memasang game yang telah jadi / masih dalam pembuatan pada smartphone dan tablet
* Memudahkan anda dalam bekerja dengan beberapa orang lain pada proyek yang sama dengan sinkronisasi instan
* Fitur berbagi antar komunitas yang memudahkan anda dalam menjelajahi proyek orang lain untuk belajar sehingga dapat digunakan dalam proyek anda sendiri

# Mulai membuat game

Anda bisa memulai dengan menjelajahi proyek pengguna lain pada bagian *Explore*

Anda juga bisa membuat game sebagai tamu, atau dapat langsung membuat akun. Buat sebuah nickname (usahakan untuk tidak menggunakan nama asli kalian), masukkan alamat email (dibutuhkan jika anda kehilangan kata sandi) dan mari mulai!
